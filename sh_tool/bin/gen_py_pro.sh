...
declare -A GEN_PY_PRO_LOGO_DATA=(
    [OWNER]="vroncevic"
    [REPO]="${GEN_PY_PRO_TOOL}"
    [VERSION]="${GEN_PY_PRO_VERSION}"
    [LOGO]="${GEN_PY_PRO_LOGO}"
)
...
function __gen_py_pro {
    ...
    display_logo GEN_PY_PRO_LOGO_DATA
