...
Copyright
    ...
    gen_py_pro is distributed in the hope that it will be useful, but
...
project: str = 'gen_py_pro'
project_copyright: str = '2024, Vladimir Roncevic <elektron.ronca@gmail.com>'
author: str = 'Vladimir Roncevic <elektron.ronca@gmail.com>'
version: str = '2.0'
release: str = 'https://github.com/vroncevic/gen_py_pro/releases'
...
htmlhelp_basename: str = 'gen_py_prodoc'
latex_elements: Dict[Any, Any] = {}
latex_documents: List[Tuple[Any, ...]] = [(
    master_doc, 'gen_py_pro.tex', 'gen_py_pro Documentation',
    'Vladimir Roncevic \\textless{}elektron.ronca@gmail.com\\textgreater{}',
    'manual'
)]
man_pages: List[Tuple[Any, ...]] = [(
    master_doc, 'gen_py_pro', 'gen_py_pro Documentation', [author], 1
)]
texinfo_documents: List[Tuple[Any, ...]] = [(
    master_doc, 'gen_py_pro', 'gen_py_pro Documentation', author, 'gen_py_pro',
