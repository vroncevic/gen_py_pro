...
RUN mkdir -p /root/scripts/gen_py_pro/ver.4.0/
RUN mkdir /root/bin/
RUN cp -R /sh_tool/bin/   /root/scripts/gen_py_pro/ver.4.0/
RUN cp -R /sh_tool/conf/  /root/scripts/gen_py_pro/ver.4.0/
RUN cp -R /sh_tool/log/   /root/scripts/gen_py_pro/ver.4.0/
RUN rm -Rf /sh_tool/
RUN chmod -R 755 /root/scripts/gen_py_pro/ver.4.0/
RUN ln -s /root/scripts/gen_py_pro/ver.4.0/bin/gen_py_pro.sh /root/bin/gen_py_pro
RUN tree /root/scripts/gen_py_pro/ver.4.0/
